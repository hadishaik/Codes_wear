  ...
  return (
    <>
      <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <a href="#" className="text-2xl font-extrabold text-pink-600">
          CodesWear
        </a>
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          ...
          <div
            ref={ref}
            className={`sideCart transform px-2
            }`}
          >
            {/* <span className="absolute top-5 right-4 cursor-pointer text-xl">
              <AiFillCloseCircle />
            </span> */}
            <ul>
                ...
                return (
                  <li key={k} className="my-5 rounded bg-white md:p-5 p-0">
                    <div className="flex container">
                      ...
                      <div className="flex w-1/5 items-center justify-end font-semibold mx-2"></div>
                    </div>
                  </li>
                );
              })}
          ...
          <form className="mt-5 grid gap-6">
            <div className="relative">
              ...
              >
                ...
                />
                <div className="ml-5">
                  <span className="mt-2 font-semibold">EKart</span>
            ...
            <div className="relative">
              ...
              >
                <img
                  className="w-14 object-contain"
                  src="https://tradebrains.in/wp-content/uploads/2022/11/Blue-Dart-logo.png"
                  alt="Delievery Partner BlueDart"
                />
                <div className="ml-5">
                  <span className="mt-2 font-semibold">Blue Dart</span>
                  <p className="text-slate-500 text-sm leading-6">
                    Delivery: 2-4 Days
                  </p>
                </div>
          ...
          <div className="">
            ...
            <div className="mt-6 border-t border-b py-2">
              <div className="flex items-center justify-between">
                ...
                <p aria-readonly className="font-semibold text-gray-900">
                  Rs.{subTotal}
                </p>
              </div>
              <div className="flex items-center justify-between">
